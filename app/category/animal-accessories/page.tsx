...
import AnimalAccessoriePage from "./AnimalAccessoriePage"

export default async function Page() {
    // Fetch category details
    const category = await getCategoryBySlug("animal-accessories")
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="container mx-auto px-4 py-6">
                ...
                <AnimalAccessoriePage subcategories={subcategories} />
