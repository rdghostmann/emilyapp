// /animal-pharmacy/AnimalPharmacyPage.tsx
"use client"
...
interface AnimalPharmacyPageProps {
  subcategories: SubcategoryDTO[]
}

export default function AnimalPharmacyPage({ subcategories }: AnimalPharmacyPageProps) {
