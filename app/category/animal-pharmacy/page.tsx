...
import AnimalPharmacyPage from "./AnimalPharmacyPage"

export default async function Page() {
  const category = await getCategoryBySlug("animal-pharmacy")
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6">
        ...
        <AnimalPharmacyPage subcategories={subcategories} />
      </div>
    </div>
  )
}
