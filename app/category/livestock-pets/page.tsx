...
import LivestockPetsPage from "./LivestockPetsPage"

export default async function Page() {
  const category = await getCategoryBySlug("livestock-pets")
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6">
        ...
        <LivestockPetsPage subcategories={subcategories} />
      </div>
    </div>
  )
}
