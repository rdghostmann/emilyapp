...
import AnimalLoanPage from "./AnimalLoanPage"

export default async function Page() {
    // Fetch category details
    const category = await getCategoryBySlug("animal-loan")
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="container mx-auto px-4 py-6">
                ...
                <AnimalLoanPage subcategories={subcategories} />
