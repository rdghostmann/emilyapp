...
import OrnamentalPage from "./OrnamentalPage"

export default async function Page() {
    // Fetch category details
    const category = await getCategoryBySlug("ornamentals")
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="container mx-auto px-4 py-6">
                ...
                <OrnamentalPage subcategories={subcategories} />
