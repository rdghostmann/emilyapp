...
import AnimalMatingPage from "./AnimalMatingPage"

export default async function Page() {
  const category = await getCategoryBySlug("animal-mating")
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6">
        ...
        <AnimalMatingPage subcategories={subcategories} />
      </div>
    </div>
  )
}
