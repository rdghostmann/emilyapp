    ...
    properties: [
      {
        ...
        values: [
          ...
          { label: "Cages", image: "/farm-equipments/cages.png" },
          { label: "Fish-Pond", image: "/farm-equipments/fish-pond.png" },
          { label: "Knapsack-Sprayer", image: "/farm-equipments/knapsack-sprayers.png" },
          { label: "Poultry-drinkers", image: "/farm-equipments/poultry-drinkers.png" },
          { label: "Power-Tillers", image: "/farm-equipments/power-tillers.png" },
          { label: "Tarpaulins", image: "/farm-equipments/tarpaulins.png" },
          { label: "Willing-Machine", image: "/farm-equipments/willing-machines.png" },
        ],
      },
